...
function createElement(appContent, strictStyleIsolation, scopedCSS, appName) {
  ...
  if (scopedCSS) {
    var attr = appElement.getAttribute(css.InSightCSSRewriteAttr);

    if (!attr) {
      appElement.setAttribute(css.InSightCSSRewriteAttr, appName);
    }
...
function _loadApp() {
  _loadApp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee16(app) {
    var configuration,
        lifeCycles,
        entry,
        appName,
      ...
      while (1) {
        switch (_context16.prev = _context16.next) {
          ...
          case 18:
            ...
            if (sandbox) {
              sandboxInstance = createSandbox(appName, // FIXME should use a strict sandbox logic while remount,
          ...
          case 37:
            ...
            parcelConfigGetter = function parcelConfigGetter() {
              ...
              var parcelConfig = {
                ...
                unmount: [/*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11() {
                  ...
                  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee12(props) {
                ...
                }(), unmountSandbox, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee13() {
