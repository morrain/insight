...
function loadMicroApp(app, configuration, lifeCycles) {
  ...
  return (0, _singleSpa.mountRootParcel)(memorizedLoadingFn, (0, _objectSpread2.default)({
...
function start() {
  ...
  if (sandbox) {
    if (!window.Proxy) {
      ...
      frameworkConfiguration.sandbox = (0, _typeof2.default)(sandbox) === 'object' ? (0, _objectSpread2.default)((0, _objectSpread2.default)({}, sandbox), {}, {
        loose: true
      }) : {
        loose: true
      };
