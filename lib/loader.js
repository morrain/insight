...
function assertElementExist(element, msg) {
  if (!element) {
    ...
    throw new Error('[insight] element not existed!');
  }
}
...
function createElement(appContent, strictStyleIsolation, scopedCSS, appName) {
  ...
  if (strictStyleIsolation) {
    if (!supportShadowDOM) {
      console.warn('[insight]: As current browser not support shadow dom, your strictStyleIsolation configuration will be ignored!');
    } else {
  ...
  if (scopedCSS) {
    var attr = appElement.getAttribute(_sandbox.css.InSightCSSRewriteAttr);

    if (!attr) {
      appElement.setAttribute(_sandbox.css.InSightCSSRewriteAttr, appName);
    }
...
function getAppWrapperGetter(appName, appInstanceId, useLegacyRender, strictStyleIsolation, scopedCSS, elementGetter) {
  return function () {
    if (useLegacyRender) {
      if (strictStyleIsolation) throw new Error('[insight]: strictStyleIsolation can not be used with legacy render!');
      if (scopedCSS) throw new Error('[insight]: experimentalStyleIsolation can not be used with legacy render!');
      var appWrapper = document.getElementById((0, _utils.getWrapperId)(appInstanceId));
      assertElementExist(appWrapper, "[insight] Wrapper element for ".concat(appName, " with instance ").concat(appInstanceId, " is not existed!"));
      return appWrapper;
    }

    var element = elementGetter();
    assertElementExist(element, "[insight] Wrapper element for ".concat(appName, " with instance ").concat(appInstanceId, " is not existed!"));
 ...
 * If the legacy render function is provide, used as it, otherwise we will insert the app element to target container by insight
 * @param appName
 * @param appContent
 * @param legacyRender
 */
  ...
  var render = function render(_ref, phase) {
    ...
    if (legacyRender) {
      if (process.env.NODE_ENV === 'development') {
        console.warn('[insight] Custom rendering function is deprecated, you can use the container element setting instead!');
      }
    ...
    if (phase !== 'unmounted') {
      var errorMsg = function () {
        switch (phase) {
          case 'loading':
          case 'mounting':
            return "[insight] Target container with ".concat(container, " not existed while ").concat(appName, " ").concat(phase, "!");

          case 'mounted':
            return "[insight] Target container with ".concat(container, " not existed after ").concat(appName, " ").concat(phase, "!");

          default:
            return "[insight] Target container with ".concat(container, " not existed while ").concat(appName, " rendering!");
        }
      }();
...
function getLifecyclesFromExports(scriptExports, appName, global) {
  ...
  if (process.env.NODE_ENV === 'development') {
    console.warn("[insight] lifecycle not found from ".concat(appName, " entry exports, fallback to get from window['").concat(appName, "']"));
  ...
  throw new Error("[insight] You need to export lifecycle functions in ".concat(appName, " entry"));
}
...
function _loadApp() {
  _loadApp = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee16(app) {
    var configuration,
        lifeCycles,
        entry,
        appName,
      ...
      while (1) {
        switch (_context16.prev = _context16.next) {
          case 0:
            ...
            markName = "[insight] App ".concat(appInstanceId, " Loading");

            if (process.env.NODE_ENV === 'development') {
              (0, _utils.performanceMark)(markName);
            }

            _configuration$singul = configuration.singular, singular = _configuration$singul === void 0 ? false : _configuration$singul, _configuration$sandbo = configuration.sandbox, sandbox = _configuration$sandbo === void 0 ? true : _configuration$sandbo, excludeAssetFilter = configuration.excludeAssetFilter, importEntryOpts = (0, _objectWithoutProperties2.default)(configuration, ["singular", "sandbox", "excludeAssetFilter"]); // get the entry html content and script executor
          ...
          case 15:
            ...
            _context16.next = 18;
            return (_prevAppUnmountedDefe = prevAppUnmountedDeferred) === null || _prevAppUnmountedDefe === void 0 ? void 0 : _prevAppUnmountedDefe.promise;
          ...
          case 18:
            ...
            if (sandbox) {
              sandboxInstance = (0, _sandbox.createSandbox)(appName, // FIXME should use a strict sandbox logic while remount,
            ...
            parcelConfigGetter = function parcelConfigGetter() {
              ...
              var parcelConfig = {
                ...
                (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5() {
                  return _regenerator.default.wrap(function _callee5$(_context5) {
                    while (1) {
                      switch (_context5.prev = _context5.next) {
                        case 0:
                          _context5.next = 2;
                          return execHooksChain((0, _utils.toArray)(beforeMount), app, global);
                  ...
                  var _ref6 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6(props) {
                    return _regenerator.default.wrap(function _callee6$(_context6) {
                      while (1) {
                        switch (_context6.prev = _context6.next) {
                          case 0:
                            return _context6.abrupt("return", mount((0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
                  ...
                  return _regenerator.default.wrap(function _callee8$(_context8) {
                    while (1) {
                      switch (_context8.prev = _context8.next) {
                        case 0:
                          _context8.next = 2;
                          return execHooksChain((0, _utils.toArray)(afterMount), app, global);
                  ...
                  return _regenerator.default.wrap(function _callee10$(_context10) {
                    while (1) {
                      switch (_context10.prev = _context10.next) {
                        case 0:
                          if (process.env.NODE_ENV === 'development') {
                            measureName = "[insight] App ".concat(appInstanceId, " Loading Consuming");
                ...
                unmount: [/*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee11() {
                  return _regenerator.default.wrap(function _callee11$(_context11) {
                    while (1) {
                      switch (_context11.prev = _context11.next) {
                        case 0:
                          _context11.next = 2;
                          return execHooksChain((0, _utils.toArray)(beforeUnmount), app, global);
                  ...
                  var _ref12 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee12(props) {
                    return _regenerator.default.wrap(function _callee12$(_context12) {
                      while (1) {
                        switch (_context12.prev = _context12.next) {
                          case 0:
                            return _context12.abrupt("return", unmount((0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
                              container: appWrapperGetter()
                            })));
                ...
                }(), unmountSandbox, /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee13() {
                  return _regenerator.default.wrap(function _callee13$(_context13) {
                    while (1) {
                      switch (_context13.prev = _context13.next) {
                        case 0:
                          _context13.next = 2;
                          return execHooksChain((0, _utils.toArray)(afterUnmount), app, global);
                ...
                })), /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee14() {
