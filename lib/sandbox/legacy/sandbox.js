...
var SingularProxySandbox = /*#__PURE__*/function () {
  (0, _createClass2["default"])(SingularProxySandbox, [{
    ...
    value: function inactive() {
      if (process.env.NODE_ENV === 'development') {
        console.info("[insight:sandbox] ".concat(this.name, " modified global properties restore..."), [].concat((0, _toConsumableArray2["default"])(this.addedPropsMapInSandbox.keys()), (0, _toConsumableArray2["default"])(this.modifiedPropsOriginalValueMapInSandbox.keys())));
  ...
  function SingularProxySandbox(name) {
    ...
    (0, _defineProperty2["default"])(this, "addedPropsMapInSandbox", new Map());
    (0, _defineProperty2["default"])(this, "modifiedPropsOriginalValueMapInSandbox", new Map());
    (0, _defineProperty2["default"])(this, "currentUpdatedPropsValueMap", new Map());
    (0, _defineProperty2["default"])(this, "name", void 0);
    (0, _defineProperty2["default"])(this, "proxy", void 0);
    (0, _defineProperty2["default"])(this, "type", void 0);
    (0, _defineProperty2["default"])(this, "sandboxRunning", true);
    this.name = name;
