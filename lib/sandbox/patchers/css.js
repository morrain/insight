...
exports.process = exports.InSightCSSRewriteAttr = exports.ScopedCSS = void 0;
...
var ScopedCSS = /*#__PURE__*/function () {
  function ScopedCSS() {
    ...
    (0, _defineProperty2["default"])(this, "swapNode", void 0);
  ...
  (0, _createClass2["default"])(ScopedCSS, [{
    ...
    value: function process(styleNode) {
      ...
      if (styleNode.textContent !== '') {
        var _styleNode$textConten, _sheet$cssRules;

        var textNode = document.createTextNode((_styleNode$textConten = styleNode.textContent) !== null && _styleNode$textConten !== void 0 ? _styleNode$textConten : '');
...
(0, _defineProperty2["default"])(ScopedCSS, "ModifiedTag", 'Symbol(style-modified-insight)');
var processor;
var InSightCSSRewriteAttr = 'data-insight';
exports.InSightCSSRewriteAttr = InSightCSSRewriteAttr;
...
var process = function process(appWrapper, stylesheetElement, appName) {
  ...
  if (tag && stylesheetElement.tagName === 'STYLE') {
    var prefix = "".concat(tag, "[").concat(InSightCSSRewriteAttr, "=\"").concat(appName, "\"]");
