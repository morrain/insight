...
function convertLinkAsStyle(element, postProcess) {
  ...
  styleElement.dataset.insightHref = href;
        ...
        case SCRIPT_TAG_NAME:
          {
            ...
            if (src) {
              ...
              var dynamicScriptCommentElement = document.createComment("dynamic script ".concat(src, " replaced by insight"));
            ...
            var dynamicInlineScriptCommentElement = document.createComment('dynamic inline script replaced by insight');
