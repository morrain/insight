...
var ProxySandbox = /*#__PURE__*/function () {
  (0, _createClass2["default"])(ProxySandbox, [{
    ...
    value: function inactive() {
      ...
      if (process.env.NODE_ENV === 'development') {
        console.info("[insight:sandbox] ".concat(this.name, " modified global properties restore..."), (0, _toConsumableArray2["default"])(this.updatedValueSet.keys()));
      }
  ...
  function ProxySandbox(name) {
    ...
    (0, _defineProperty2["default"])(this, "updatedValueSet", new Set());
