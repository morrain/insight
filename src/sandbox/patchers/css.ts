...
export class ScopedCSS {
  private static ModifiedTag = 'Symbol(style-modified-insight)'

  private readonly sheet: StyleSheet

  private readonly swapNode: HTMLStyleElement
...
export const InSightCSSRewriteAttr = 'data-insight'
export const process = (
  ...
  if (tag && stylesheetElement.tagName === 'STYLE') {
    const prefix = `${tag}[${InSightCSSRewriteAttr}="${appName}"]`
