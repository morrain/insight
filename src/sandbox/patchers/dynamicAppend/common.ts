      ...
      switch (element.tagName) {
        ...
        case SCRIPT_TAG_NAME: {
          ...
          if (src) {
            ...
            const dynamicScriptCommentElement = document.createComment(`dynamic script ${src} replaced by insight`)
          ...
          const dynamicInlineScriptCommentElement = document.createComment('dynamic inline script replaced by insight')
