...
export default class ProxySandbox implements SandBox {
  /** window 值变更记录 */
  private readonly updatedValueSet = new Set<PropertyKey>()
  ...
  inactive() {
    ...
    if (--activeSandboxCount === 0) {
      variableWhiteList.forEach(p => {
        if (Object.prototype.hasOwnProperty.call(this.proxy, p)) {
          // @ts-expect-error
  ...
  constructor(name: string) {
    ...
    const hasOwnProperty = (key: PropertyKey) =>
      Object.prototype.hasOwnProperty.call(fakeWindow, key) || Object.prototype.hasOwnProperty.call(rawWindow, key)
